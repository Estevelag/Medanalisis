...
```{r}
library(readxl)
path_data<-"BasedatosRegDeriv.xlsx" #To do a linear model of the change in the next measure
...
```{r}
# Final model
mod2<-gamlss(`tfgC_per_month_next` ~`Creatinina_1`+Peso_Kg+Presion_Art_Sistolica+BUN1_mg_d+Albumina_2+Calcio_mg_dl+Fosforo_mEq_L_l+Peso_Kg:Presion_Art_Sistolica+Peso_Kg:RCV_Rel_AlbuminuriaCreatinuria, data=full_data, family=TF)
...
# Interactions plot visualization

```{r}
#library(GGally)
#ggpairs(full_data, columns = 2:29)
```
