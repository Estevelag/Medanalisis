...
```{r}
#library(GGally)
#ggpairs(full_data, columns = 2:28)

# Validar todos los valores extremos de cada cosa tenerlos en indicees y tener un excel de estos

# Comparación python, R

# Creatinas a nuevas fiilas
```
